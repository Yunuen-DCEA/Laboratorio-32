...
genes <- as.matrix(
  read.csv("C:\\Users\\yunh_\\Downloads\\heatmap_data.csv",
    sep = ",",
    header = T,
    row.names = 1))

annotation_col <- read.csv("C:\\Users\\yunh_\\Downloads\\annotation_col.csv", header = T,
           row.names = 1)

annotation_row <- read.csv("C:\\Users\\yunh_\\Downloads\\annotation_row.csv", header = T,
                           row.names = 1)
